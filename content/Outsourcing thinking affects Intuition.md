...
Good intuition can be many things;  a heuristic for how things should work, a good guess about how to solve something, a feel for what works and wouldn't. Our intuition becomes better with context and information, which can only be gained by trying and failing multiple times. This is why the "arena" concept is popular amongst high agency people. True learning and intuition building can only happen in the arena.
